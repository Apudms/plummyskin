              ...
              <form class="form form-horizontal">
                <div class="form-body">
                  <div class="row">
                    ...
                    <div class="col-md-9 form-group">
                      <label class="text-bold-500">: <b>{{ $reseller->email }}</b></label>
                    </div>
                    <div class="col-md-3">
                      <label>Password</label>
                    </div>
                    <div class="col-md-9 form-group">
                      <label class="text-bold-500">: <b>{{ $reseller->password }}</b></label>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-9 form-group">
                      <label class="text-bold-500">: <b>{{ $reseller->distributor->namaDepan }} {{ $reseller->distributor->namaBelakang }} ({{ $reseller->distributor->wilayah }})</b></label>
                    </div>
                    <div class="col-12 d-flex justify-content-start mt-4">
                      <a href="/admin/reseller" class="btn btn-secondary me-2"><i class="fas fa-arrow-left me-lg-2"></i>Kembali</a>
                    </div>
                  </div>
                </div>
              </form>
