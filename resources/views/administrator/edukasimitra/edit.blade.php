      ...
      <div class="col-12">
        <div class="card">
          <div class="card-content">
            <div class="card-body">
              <form class="form" action="/admin/edukasimitra/{{ $edukasimitra->id }}" method="post">
                @method('put')
                @csrf
                <div class="row">
                  <div class="col-md-6 col-12">
                    <div class="form-group">
                      ...
                      <input type="text" @error('link') is-invalid @enderror id="link" class="form-control" placeholder="Link"
                        name="link" required value="{{ old('link', $edukasimitra->link) }}">
                    </div>
                  </div>
                  <div class="col-md-6 col-12">
                    <div class="form-group">
                      ...
                      <input type="text" @error('keterangan') is-invalid @enderror id="keterangan" class="form-control" placeholder="Keterangan"
                        name="keterangan" required value="{{ old('keterangan', $edukasimitra->keterangan) }}">
                    </div>
                  </div>
